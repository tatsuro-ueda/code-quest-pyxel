...
### J21: 友達に見せる → 遊ばれているか知る

子どもが作ったゲームを友達にURLで送る。スマホで即プレイできることが「見せる」のハードルを劇的に下げる。さらに、親がアクセスログで「実際に遊ばれたか」を確認し、次のアクションにつなげる。
...
flowchart LR
    ...
    subgraph After["After"]
        ...
        A5 --> A6[親がログで確認: 遊ばれてる！ → 嬉しい]
        A6 --> A7[0回なら「やってみた？」と声かけ]
    end
```
...
親がAIに頼んだ修正を、子どもが「おためし」と「もとのまま」の両方で遊び比べて、自分の体感で「こっち！」と決める。選択ページの説明は、実際に入っている変更と一致していなければならない。
...
子どもが両方遊んだ結果「まえのがいい」と自信を持って却下する。親の理屈に言い返せなくても、遊んだ体感が根拠になる。
...
親がAIに複数の修正を頼んだとき、子どもがどれを採用するか・どの順で入れるかを選ぶ。優先順位を決めるのは子ども。選択ページの変更一覧は、実際に遊べる変更と一対一に対応している必要がある。
...
| J42 | 育てる | 子どもが冒険を最後までやり切れる | J2: 好循環 |
| J31 | 守る | 子どもが変更を承認する | J1: コミュニケーション, J2: 好循環 |
| J32 | 守る | 子どもが変更を却下する | J1: コミュニケーション |
| J33 | 守る | 子どもが変更を選んで適用する | J1: コミュニケーション, J2: 好循環 |
| J34 | 守る | 承認したあとに「やっぱり」となる | J1: コミュニケーション, J2: 好循環 |
| J35 | 避ける | AIで修正したらエラーが出て動かない | J2: 好循環（ブレーキ役） |
| J36 | 避ける | データを変えたらバランスが崩壊した | J2: 好循環 |
| J37 | 避ける | 見た目・音を変えたら表示が壊れた | J1: コミュニケーション, J2: 好循環 |
| J38 | 避ける | 新しいイベントを追加したら既存が壊れた | J2: 好循環 |
| J39 | 避ける | システムを変えたらゲーム全体が壊れた | J2: 好循環 |
| J40 | 避ける | ゲームモードを追加したら収拾がつかなくなった | J2: 好循環 |
| J41 | 避ける | 技術基盤を変えたら配信できなくなった | J2: 好循環, J3: アウトプット品質 |
