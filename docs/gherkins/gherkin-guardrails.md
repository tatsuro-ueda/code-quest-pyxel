...
`J42: 子どもが冒険を最後までやり切れる` のうち、「進行が止まらず最後までつながる」部分を主にここで守る。
...
`J42: 子どもが冒険を最後までやり切れる` のうち、「戦闘・成長・操作がRPGとして破綻しない」部分を主にここで守る。
...
| G9 | ヘッドレスシナリオテスト（4シナリオ） | J38-J39（J42縦断体験を含む） | `make build` | 承認キューから除外 |
