...
| **G20** | **M5 命名・テスト・AI ガードレール可視化** | **CJG37 責務・構造** | `src/scenes/<scene>/` 命名 find, Model / Presenter 単体テスト存在, AGENTS.md / repository-structure.md 取り込み | 未実装 |
...
| 3. AGENTS.md / repository-structure.md | SSoTルール・編集禁止ファイル・テスト必須・framework-rule.md M1〜M5 を明記 | ✅ | ✅ | — |
