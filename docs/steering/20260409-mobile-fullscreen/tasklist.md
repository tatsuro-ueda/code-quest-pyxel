...
- [x] 1. ブランチ作成: `git checkout -b feature/mobile-fullscreen main`
- [x] 2. `templates/wrapper.html` を新規作成（HTMLラッパーテンプレート）
...
- [x] 3. `tools/build_web_release.py` を拡張
...
- [x] 5. コミット
- [x] 6. `git log origin/main..HEAD --oneline` で確認 → 1コミットのみ、混入なし
