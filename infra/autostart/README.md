...
- `production/` artifacts が未生成なら起動時に自動ビルド（`ensure_production_build`）
...
# 5. ログ確認（起動時の ensure_production_build 結果など）
...
- `tools/web_runtime_server.py` line 155-175: `ensure_production_build()` の詳細
